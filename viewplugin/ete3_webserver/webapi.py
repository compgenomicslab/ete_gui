...
bottle.BaseRequest.MEMFILE_MAX = 1024 * 10000 # (or whatever you want)
#print(bottle.BaseRequest.MEMFILE_MAX)
...
# @route('/ete_view') #change index
# def index():
#      return static_file("webplugin_example.html", root='../demo')
...
def start_setting(node_actions=None, tree_style=None):
    ...
    #eel.init('.')
    #eel.start('../demo/webplugin_example.html', size=(1200, 1200))
